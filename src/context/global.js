...
import { toast, ToastContainer } from 'react-toastify'; // Importa o Toastify
...
export const GlobalContextProvider = ({ children }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (search) {
            ...
            state.isSearch = false;
            toast.error('Please enter a search term'); // Substitui alert por Toastify
        }
    }
    ...
    return (
        <GlobalContext.Provider value={{
            ...
            {children}
            <ToastContainer /> {/* Coloca o ToastContainer aqui */}
